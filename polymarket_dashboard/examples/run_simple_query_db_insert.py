import asyncio
from polymarket_dashboard.src.polymarket_dashboard.src.stream.binance import binance_price_ws
from concurrent.futures import ProcessPoolExecutor
from polymarket_dashboard.src.polymarket_dashboard.src.db.ingest_stream import insert_into_db, parse_message
